			...
			\begin{list}{--}{}
				...
				\item \textit{Thiết bị điều khiển:}
					\begin{list}{+}{}
						...
						\item Trên cơ sở tín hiệu đo và cấu trúc điều khiển, bộ điều khiển có thể thực hiện thuật toán và xuất tín hiệu ra để can thiệp quá trình kỹ thuật thông qua cơ cấu chấp hành.
